...
public class ShelfView : MonoBehaviour
{
    ...
    private float previewYOffset = 22f;
    ...
    public bool TryClearTriple()
    {
        ...
        {
            // ================================== 🎧 AUDIO MANAGER CALL ==================================
            AudioManager.Instance?.PlayCollectCooled();
        }
    ...
    public SlotView FindFirstEmptySlot()
    {
        ...
        {
            var s = slots[i];
            if (s != null && !s.HasItem)  // использует твое свойство HasItem
                return s;
        }
        return null;
    }
